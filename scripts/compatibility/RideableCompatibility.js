...
import { cDnD5e, cPf2e, cStairways, cTagger, cWallHeight, cLocknKey, cMATT } from "./RideableCompUtils.js";
//			SW			TGG		WH
	...
	switch (game.system.id) {
		...
		case cPf2e:
			...
			function cNewDistance(pTarget, { reach = null } = {}) {
				...
				return (cOldDistance.bind(this))(cActualTarget, {reach});
			}
			
			CONFIG.Token.objectClass.prototype.distanceTo = cNewDistance;
